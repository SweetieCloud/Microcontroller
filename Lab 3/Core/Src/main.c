...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, R1_Pin|Y1_Pin|G1_Pin|R2_Pin
                          |Y2_Pin|G2_Pin|s00_Pin|s01_Pin
                          |s02_Pin|s03_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, s10_Pin|s11_Pin|s12_Pin|s32_Pin
                            |s33_Pin|mode0_Pin|mode1_Pin|mode2_Pin|mode3_Pin
                            |s13_Pin|s20_Pin|s21_Pin|s22_Pin
                            |s23_Pin|s30_Pin|s31_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : s10_Pin s11_Pin s12_Pin s32_Pin
                             s33_Pin mode0_Pin mode1_Pin mode2_Pin mode3_Pin
                             s13_Pin s20_Pin s21_Pin s22_Pin
                             s23_Pin s30_Pin s31_Pin */
  GPIO_InitStruct.Pin = s10_Pin|s11_Pin|s12_Pin|s32_Pin
                          |s33_Pin|mode0_Pin|mode1_Pin|mode2_Pin|mode3_Pin
                          |s13_Pin|s20_Pin|s21_Pin|s22_Pin
                          |s23_Pin|s30_Pin|s31_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
