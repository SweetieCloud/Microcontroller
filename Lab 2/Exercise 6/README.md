# Exercise 6: Software Timer for Non-Blocking Delay ⏱️
...
```c
/* USER CODE BEGIN 0 */
// ... (display7SEG, update7SEG, updateClockBuffer functions)

// SOFTWARE TIMER IMPLEMENTATION (Program 1.6)
int timer0_counter = 0;
int timer0_flag = 0;
int TIMER_CYCLE = 10; // 10ms (Chu kỳ ngắt Timer 2)
